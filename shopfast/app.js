...
app.use('/users', require('./lib/routes/users')(defaultRouter(), MongoDatabase));
app.use('/contactus', require('./lib/routes/contactus')(defaultRouter(), MongoDatabase));
app.use('/cart', require('./lib/routes/cart')(defaultRouter(), MongoDatabase));
app.use('/products', require('./lib/routes/products')(defaultRouter(), MongoDatabase));
//app.use('/searchbybrand', require('./lib/routes/products')(defaultRouter(), MongoDatabase));
